...
import com.homefellas.rm.repeatsetup.IRepeatSetupDao;
...
//		Assert.assertTrue(tasks.isEmpty());
	...
	public void getNextTaskByRepeatSetup()
	{
		...
		repeatSetup.setClonedTask(new TaskTemplate(task));
		repeatSetup.setMember(profile.getMember());
		
		try
		{
			repeatSetupDao.createTaskTemplate(repeatSetup.getClonedTask());
	...
	public void testGetGenericCalendars()
	{
		...
		List<Calendar> genericCalendars = calendarDao.getGenericCalendars();
...
//		assertFalse(genericCalendars.contains(calendarUserCreated));
	...
	public void testGetUserDefinedCalendars()
	{
		...
		List<Calendar> userDefinedCalendars = calendarDao.getUserDefinedCalendars(memeber1);
