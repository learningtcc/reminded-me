...
import com.homefellas.rm.share.SynchronizeShareCalendar;
...
//		Invite(Invite.class),
		...
		shareCalendar(ShareCalendar.class),
		SynchronizeShareCalendar(SynchronizeShareCalendar.class, Calendar.class);
