...
public class NotificationDaoTest extends AbstractTestDao
{
	...
	protected void createDatabaseDefaults()
	{
		...
		notificationDao.createNotification(notification1Queued);
		...
		notificationDao.createNotification(notification2Sent);
		...
		notificationDao.createNotification(notification3Queued);
		...
		notificationDao.createNotification(notification4Failed);
		...
		notificationDao.createNotification(notification5Queued);
		...
		notificationDao.createNotification(notification6Canceled);
		...
		notificationDao.createNotification(notification7QueuedInstant);
	}
	...
	public void testFutureNonSends()
	{
		...
		notificationDao.createNotification(futureNotification);
